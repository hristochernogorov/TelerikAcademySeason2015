//Problem 4:Write a program, that reads from the console an array of N integers and an integer K, sorts the array and 
...
class BinarySearch
{
    static void Main()
    {
        ...
        {
            Console.WriteLine("In array {0} integer are smoller or equal then K={1} ", count, k);
        }
    }
}
